...
Variable fOr_27_ : Universe -> Prop.
...
Variable initial_model_1 : (dom_ good_ /\ (dom_ bad_ /\ (dom_ X1 /\ (tAnd_19_ X1 /\ tALGORITHM_ X1)))).
...
Variable ax00_8 : (forall X1 : Universe, ((tAnd_19_ X1 /\ fForall_18_ X1) -> goal_)).
Variable ax01_9 : (forall W : Universe, ((tAnd_36_ W /\ fForall_35_ W) -> goal_)).
Variable ax02_10 : (forall Y Z W : Universe, ((tAnd_44_ Y Z W /\ fOUTPUTS_ W good_) -> goal_)).
Variable ax03_11 : (forall Y Z W : Universe, ((tAnd_48_ Y Z W /\ fOUTPUTS_ W bad_) -> goal_)).
Variable ax04_12 : (forall Y Z W : Universe, ((tAnd_59_ Y Z W /\ fOr_58_ Y Z W) -> goal_)).
Variable ax05_13 : (forall Y Z W : Universe, ((tAnd_63_ Y Z W /\ tHALTS2_ Y Z) -> goal_)).
Variable ax06_14 : (forall Y Z W : Universe, ((tAnd_63_ Y Z W /\ fOr_62_ Y Z W) -> goal_)).
Variable ax07_15 : (forall W Y V : Universe, ((tAnd_74_ W Y V /\ fOr_69_ W V Y) -> goal_)).
Variable ax08_16 : (forall Y V : Universe, ((tAnd_70_ Y V /\ fOUTPUTS_ V bad_) -> goal_)).
Variable ax09_17 : (forall X1 Y1 : Universe, (fOr_16_ X1 Y1 -> fForall_18_ X1)).
Variable ax10_18 : (forall Y1 X1 : Universe, ((tPROGRAM_ Y1 /\ fForall_14_ X1 Y1) -> fOr_16_ X1 Y1)).
Variable ax11_19 : (forall X1 Y1 Z1 : Universe, (fDECIDES_ X1 Y1 Z1 -> fForall_14_ X1 Y1)).
Variable ax12_20 : (forall X : Universe, (fOr_27_ X -> fForall_29_)).
...
Variable ax28_35 : (fForall_29_ -> (exists W : Universe, (dom_ W /\ (tAnd_36_ W /\ tPROGRAM_ W)))).
...
Variable ax31_38 : (forall X : Universe, (tALGORITHM_ X -> (exists Y : Universe, (fOr_27_ X \/ (dom_ Y /\ (tPROGRAM_ Y /\ tExists_22_ X Y)))))).
