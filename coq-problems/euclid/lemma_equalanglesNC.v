...
Variable lemma_ray2_3 : (forall A B C : Universe, (out_ A B C -> A <> B)).
...
Theorem lemma_equalanglesNC_11 : (forall A B C Xa Xb Xc : Universe, (congA_ A B C Xa Xb Xc -> ~(col_ Xa Xb Xc))).
Proof.
  time tac.
Qed.
