...
Variable lemma_ray3_3 : (forall B C D V : Universe, ((out_ B C D /\ out_ B C V) -> out_ B D V)).

Theorem lemma_equalangleshelper_4 : (forall A B C Xa Xb Xc Xp Xq : Universe, ((congA_ A B C Xa Xb Xc /\ (out_ Xb Xa Xp /\ out_ Xb Xc Xq)) -> congA_ A B C Xp Xb Xq)).
Proof.
  time tac.
Qed.
