...
Variable proposition_28B_7 : (forall A B C D G H : Universe, ((betS_ A G B /\ (betS_ C H D /\ (rT_ B G H G H D /\ oS_ B D G H))) -> par_ A B C D)).
...
Theorem proposition_28C_18 : (forall B D G H : Universe, ((rT_ B G H G H D /\ oS_ B D G H) -> par_ G B H D)).
Proof.
  time tac.
Qed.
