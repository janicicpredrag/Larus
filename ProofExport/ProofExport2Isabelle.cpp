...
void ProofExport2Isabelle::OutputPrologue(ofstream& outfile, Theory& T, const CLFormula& cl , const string& theoremName, const map<string,string>& /*instantiation*/, proverParams& /* params */)
{
