#ifndef PROOFEXPORT2LAMBDAPI_H
#define PROOFEXPORT2LAMBDAPI_H

#include "ProofExport.h"

class ProofExport2LambdaPi : public ProofExport {
public:
  ProofExport2LambdaPi();
