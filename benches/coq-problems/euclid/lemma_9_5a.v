...
Variable postulate_Pasch_outer_4 : (forall A B C P Q : Universe, (exists X : Universe, ((betS_ A P C /\ (betS_ B C Q /\ ~(col_ B Q A))) -> (betS_ A X Q /\ betS_ B P X)))).
...
Theorem lemma_9_5a_16 : (forall A B C P Q R : Universe, ((tS_ P A B C /\ (betS_ R P Q /\ (~(col_ R Q C) /\ col_ A B R))) -> tS_ Q A B C)).
Proof.
  time tac.
Qed.
