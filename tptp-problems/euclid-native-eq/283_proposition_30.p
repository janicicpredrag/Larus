...
fof(lemma_30helper,axiom, (! [A,B,E,F,G,H] : ((par(A,B,E,F) & betS(A,G,B) & betS(E,H,F) & ~ (cR(A,F,G,H))) => ((cR(A,E,G,H)))))).
...
fof(proposition_30,conjecture,(! [A,B,C,D,E,F,G,H,K] : ((par(A,B,E,F) & par(C,D,E,F) & betS(G,H,K) & col(A,B,G) & col(E,F,H) & col(C,D,K) & ( A != G ) & ( E != H ) & ( C != K )) => ((par(A,B,C,D)))))).
