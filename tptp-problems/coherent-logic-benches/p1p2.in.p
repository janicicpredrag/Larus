...
fof(papp1,axiom, ![ A, B, C, L, D, E, F, M, G, N, O, H, P, Q, I, R, S] : ((col(A,B,C,L) & col(D,E,F,M) & col(B,F,G,N) & col(C,E,G,O) & col(B,D,H,P) & col(A,E,H,Q) & col(C,D,I,R) & col(A,F,I,S)) => ( ? [T ]:  ((dom(T) & col(G,H,I,T)))|pl(A,M)|pl(B,M)|pl(C,M)|pl(D,L)|pl(E,L)|pl(F,L)) )).
