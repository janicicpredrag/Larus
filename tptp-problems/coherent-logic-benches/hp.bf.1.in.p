...
fof(ax00,axiom, ![ X1] : ((tAnd_19(X1) & fForall_18(X1)) =>  goal )).
fof(ax01,axiom, ![ W] : ((tAnd_36(W) & fForall_35(W)) =>  goal )).
fof(ax02,axiom, ![ Y, Z, W] : ((tAnd_44(Y,Z,W) & fOUTPUTS(W,good)) =>  goal )).
fof(ax03,axiom, ![ Y, Z, W] : ((tAnd_48(Y,Z,W) & fOUTPUTS(W,bad)) =>  goal )).
fof(ax04,axiom, ![ Y, Z, W] : ((tAnd_59(Y,Z,W) & fOr_58(Y,Z,W)) =>  goal )).
fof(ax05,axiom, ![ Y, Z, W] : ((tAnd_63(Y,Z,W) & tHALTS2(Y,Z)) =>  goal )).
fof(ax06,axiom, ![ Y, Z, W] : ((tAnd_63(Y,Z,W) & fOr_62(Y,Z,W)) =>  goal )).
fof(ax07,axiom, ![ W, Y, V] : ((tAnd_74(W,Y,V) & fOr_69(W,V,Y)) =>  goal )).
fof(ax08,axiom, ![ Y, V] : ((tAnd_70(Y,V) & fOUTPUTS(V,bad)) =>  goal )).
fof(ax09,axiom, ![ X1, Y1] : (fOr_16(X1,Y1) => fForall_18(X1) )).
fof(ax10,axiom, ![ Y1, X1] : ((tPROGRAM(Y1) & fForall_14(X1,Y1)) => fOr_16(X1,Y1) )).
fof(ax11,axiom, ![ X1, Y1, Z1] : (fDECIDES(X1,Y1,Z1) => fForall_14(X1,Y1) )).
fof(ax12,axiom, ![ X] : (fOr_27(X) => fForall_29 )).
...
fof(ax28,axiom, (fForall_29 =>  ? [W ]:  ((dom(W) & tAnd_36(W) & tPROGRAM(W))) )).
fof(ax29,axiom, ![ X, Y] : (tExists_22(X,Y) =>  ? [Z ]:  ((dom(Z) & fDECIDES(X,Y,Z))) )).
fof(ax30,axiom, ![ W, Y] : (tExists_40(W,Y) =>  ? [Z ]:  ((dom(Z) & fDECIDES(W,Y,Z))) )).
fof(ax31,axiom, ![ X] : (tALGORITHM(X) => ? [Y] : (fOr_27(X)| ((dom(Y) & tPROGRAM(Y) & tExists_22(X,Y)))) )).
