...
fof(inAngle_neg_elim,axiom, (! [A,B,C,D] : ((inAngle(A,B,C,D) & ninAngle(A,B,C,D)) => (($false))))).
...
fof(inAngle_excluded_middle,axiom, (! [A,B,C,D] : ((inAngle(A,B,C,D)) | (ninAngle(A,B,C,D))))).
...
fof(inAngle_EqSub_0,axiom, (! [A,B,C,D,X] : ((eq(A,X) & inAngle(A,B,C,D)) => ((inAngle(X,B,C,D)))))).
fof(inAngle_EqSub_1,axiom, (! [A,B,C,D,X] : ((eq(B,X) & inAngle(A,B,C,D)) => ((inAngle(A,X,C,D)))))).
fof(inAngle_EqSub_2,axiom, (! [A,B,C,D,X] : ((eq(C,X) & inAngle(A,B,C,D)) => ((inAngle(A,B,X,D)))))).
fof(inAngle_EqSub_3,axiom, (! [A,B,C,D,X] : ((eq(D,X) & inAngle(A,B,C,D)) => ((inAngle(A,B,C,X)))))).
fof(ninAngle_EqSub_0,axiom, (! [A,B,C,D,X] : ((eq(A,X) & ninAngle(A,B,C,D)) => ((ninAngle(X,B,C,D)))))).
fof(ninAngle_EqSub_1,axiom, (! [A,B,C,D,X] : ((eq(B,X) & ninAngle(A,B,C,D)) => ((ninAngle(A,X,C,D)))))).
fof(ninAngle_EqSub_2,axiom, (! [A,B,C,D,X] : ((eq(C,X) & ninAngle(A,B,C,D)) => ((ninAngle(A,B,X,D)))))).
fof(ninAngle_EqSub_3,axiom, (! [A,B,C,D,X] : ((eq(D,X) & ninAngle(A,B,C,D)) => ((ninAngle(A,B,C,X)))))).
