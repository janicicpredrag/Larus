fof(goal, conjecture,![X1,X2,Y1,Y2,A,B]:((perp(X1,X2,A,B)&perp(Y1,Y2,A,B)&col(X1,Y1,Y2))=>(col(X2,Y1,Y2)))).
...
fof(perp_perp_col,axiom,![X,Y,Z,A,B]:((perp(X,Y,A,B)&perp(X,Z,A,B))=>(col(X,Y,Z)))).
