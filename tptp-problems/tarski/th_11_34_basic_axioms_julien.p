...
fof(in_angle_asym,axiom,![A,B,C,D]:((point_in_angle(D,A,B,C)&point_in_angle(C,A,B,D))=>(cong_angle(A,B,C,A,B,D)))).
...
fof(goal, conjecture,(![A,B,C,D,E,F]:((le_angle(A,B,C,D,E,F)&le_angle(D,E,F,A,B,C))=>cong_angle(A,B,C,D,E,F)))).
