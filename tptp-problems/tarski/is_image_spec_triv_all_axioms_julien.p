...
fof(ax_6_8_1, axiom, (! [P,A,X] : ((A!=P & point_on_halfline(X,P,A)) => out(P,X,A)))).
fof(ax_6_8_2, axiom, (! [P,A,X] : ((A!=P & out(P,X,A)) => point_on_halfline(X,P,A)))).
...
fof(ax_same_lines_false, axiom, (! [A,B,C,D] : ((same_lines(A,B,C,D) & nsame_lines(A,B,C,D)) => $false))).
...
fof(ax_branch_line, axiom, (! [A,B,C] : (A!=B => (point_on_line(C,A,B) | npoint_on_line(C,A,B))))).
fof(ax_false_line, axiom, (! [A,B,C] : ((point_on_line(C,A,B) & npoint_on_line(C,A,B)) => $false))).
...
fof(ax_false_per, axiom,(![A,B,C] : ((per(A,B,C) & nper(A,B,C))))).
...
%ax_8_11_3 sam ja vec izrazila preko prethodnih definicija
fof(ax_branch_perp_in, (![X,A,B,C,D] : (perp_in(X,A,B,C,D) | nperp_in(X,A,B,C,D)))).
fof(ax_false_perp_in, (! [X,A,B,C,D] : ((perp_in(X,A,B,C,D) & nperp_in(X,A,B,C,D)) => $false))).
fof(ax_branch_perp, (![A,B,C,D] : (perp(A,B,C,D) | nperp(A,B,C,D)))).
fof(ax_false_perp, (! [A,B,C,D] : ((perp(A,B,C,D) & nperp(A,B,C,D)) => $false))).
...
fof(ax_same_planes_ex_middle, axiom, (! [A,B,C,P,Q,R] : ((same_planes3p(A,B,C,P,Q,R) | nsame_planes3p(A,B,C,P,Q,R))))).
fof(ax_same_planes_false, axiom, (! [A,B,C,P,Q,R] : ((same_planes3p(A,B,C,P,Q,R) & nsame_planes3p(A,B,C,P,Q,R)) => $false))).
...
fof(ax_10_3_1, axiom, (! [P,P1,A,B] : ((is_image_spec(P1,P,A,B)) => ((? [X] : (is_midpoint(X,P,P1) & point_on_line(X,A,B) & perp(A,B,P,P1))) | (? [X] : (is_midpoint(X,P,P1) & point_on_line(X,A,B) & P=P1)))))).
fof(ax_10_3_2_1, axiom, (! [P,P1,A,B,X] : ((is_midpoint(X,P,P1) & point_on_line(X,A,B) & perp(A,B,P,P1)) => is_image_spec(P1,P,A,B)))).
%fof(ax_10_3_2_2, axiom, (! [P,P1,A,B,X] : ((is_midpoint(X,P,P1) & point_on_line(X,A,B) & P=P1) => is_image_spec(P1,P,A,B)))).
fof(ax_10_3_2_2, axiom, (! [P,A,B,X] : ((is_midpoint(X,P,P) & point_on_line(X,A,B)) => is_image_spec(P,P,A,B)))).
fof(ax_branch_is_image_spec, (! [A,B,C,D] : (is_image_spec(A,B,C,D) | nis_image_spec(A,B,C,D)))).
fof(ax_false_is_image_spec, (! [A,B,C,D] : ((is_image_spec(A,B,C,D) & nis_image_spec(A,B,C,D)) => $false))).
...
fof(ax_is_image_spec_in_1, axiom, (![M,P1,P,A,B] : ((is_image_spec_in(M,P1,P,A,B)) => ((is_midpoint(M, P, P1) & col(A,B,M) & perp(A,B,P,P1)) | (is_midpoint(M,P,P1) & col(A,B,M) & P = P1))))).
fof(ax_is_image_spec_in_2, axiom, (![M,P1,P,A,B] : ((is_midpoint(M, P, P1) & col(A,B,M) & perp(A,B,P,P1)) => (is_image_spec_in(M,P1,P,A,B))))).
fof(ax_is_image_spec_in_3, axiom, (![M,P,A,B] : ((is_midpoint(M, P, P) & col(A,B,M)) => (is_image_spec_in(M,P,P,A,B))))).
...
fof(ax_branch_int, axiom, (! [A,B,C,D] : ((int(A,B,C,D) & nint(A,B,C,D)) => $false))).
fof(ax_false_int, axiom, (! [A,B,C,D] : ((int(A,B,C,D) | nint(A,B,C,D))))).
...
fof(ax_branch_parallel_broad, (! [A,B,C,D] : ((parallel_broad(A,B,C,D) | nparalellel_broad(A,B,C,D))))).
fof(ax_false_parallel_broad, (! [A,B,C,D] : ((parallel_broad(A,B,C,D) & nparalellel_broad(A,B,C,D)) => $false))).
