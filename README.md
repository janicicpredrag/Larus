...
In each particular invocation of larus, your Isabelle bin folder (e.g. ~/Isabelle2022/bin/) should be given as an argument to larus, after the option -visa, e.g:
