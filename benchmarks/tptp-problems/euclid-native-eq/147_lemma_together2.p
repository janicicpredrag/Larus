...
fof(lemma_together2,conjecture,(! [A,B,C,F,G,M,N,Xa,Xb,Xc] : ((tG(A,Xa,C,Xc,B,Xb) & cong(F,G,B,Xb) & on_ray(F,G,M) & cong(F,M,A,Xa) & on_ray(G,F,N) & cong(G,N,C,Xc)) => ((on_ray(M,F,N)))))).
