...
fof(propsame_sideition_28B,axiom, (! [A,B,C,D,G,H] : ((between(A,G,B) & between(C,H,D) & rT(B,G,H,G,H,D) & same_side(B,D,G,H)) => ((parallel(A,B,C,D)))))).
...
fof(propsame_sideition_28C,conjecture,(! [B,D,G,H] : ((rT(B,G,H,G,H,D) & same_side(B,D,G,H)) => ((parallel(G,B,H,D)))))).
