...
fof(propsame_sideition_30B,conjecture,(! [A,B,C,D,E,F,G,H,K] : ((parallel(A,B,E,F) & parallel(C,D,E,F) & between(G,K,H) & between(A,G,B) & between(E,H,F) & between(C,K,D) & opposite_sides(A,G,H,F) & opposite_sides(C,K,H,F)) => ((parallel(A,B,C,D)))))).
