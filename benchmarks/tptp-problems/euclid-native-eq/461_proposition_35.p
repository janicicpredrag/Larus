...
fof(propsame_sideition_35A,axiom, (! [A,B,C,D,E,F] : ((parallelogram(A,B,C,D) & parallelogram(E,B,C,F) & between(A,D,F) & collinear(A,E,F)) => ((eF(A,B,C,D,E,B,C,F)))))).
fof(lemma_parallelPasch,axiom, (! [A,B,C,D,E] : (? [X] : ((parallelogram(A,B,C,D) & between(A,D,E)) => ((between(B,X,E) & between(C,X,D))))))).
...
fof(propsame_sideition_35,conjecture,(! [A,B,C,D,E,F] : ((parallelogram(A,B,C,D) & parallelogram(E,B,C,F) & collinear(A,D,E) & collinear(A,D,F)) => ((eF(A,B,C,D,E,B,C,F)))))).
