...
fof(lemma_35helper,axiom, (! [A,B,C,D,E,F] : ((parallelogram(A,B,C,D) & parallelogram(E,B,C,F) & between(A,D,F) & collinear(A,E,F)) => ((between(A,E,F)))))).
...
fof(lemma_trapezoiddiagonals,axiom, (! [A,B,C,D,E] : (? [X] : ((parallelogram(A,B,C,D) & between(A,E,D)) => ((between(B,X,D) & between(C,X,E))))))).
fof(lemma_EFreflexive,axiom, (! [Xa,Xb,Xc,Xd,Xp] : ((between(Xa,Xp,Xc) & between(Xb,Xp,Xd) & ~ (collinear(Xa,Xb,Xc))) => ((eF(Xa,Xb,Xc,Xd,Xa,Xb,Xc,Xd)))))).
...
fof(propsame_sideition_35A,conjecture,(! [A,B,C,D,E,F] : ((parallelogram(A,B,C,D) & parallelogram(E,B,C,F) & between(A,D,F) & collinear(A,E,F)) => ((eF(A,B,C,D,E,B,C,F)))))).
