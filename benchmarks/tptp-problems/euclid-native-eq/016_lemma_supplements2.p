...
fof(lemma_supplemenopposite_sides2,conjecture,(! [A,B,C,D,E,F,J,K,L,P,Q,R] : ((rT(A,B,C,P,Q,R) & congruent_angles(A,B,C,J,K,L) & rT(J,K,L,D,E,F)) => ((congruent_angles(P,Q,R,D,E,F) & congruent_angles(D,E,F,P,Q,R)))))).
