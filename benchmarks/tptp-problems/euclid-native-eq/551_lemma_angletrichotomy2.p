...
fof(lemma_angletrichotomy2,conjecture,(! [A,B,C,D,E,F] : ((~ (collinear(A,B,C)) & ~ (collinear(D,E,F)) & ~ (congruent_angles(A,B,C,D,E,F)) & ~ (lt_angles(D,E,F,A,B,C))) => ((lt_angles(A,B,C,D,E,F)))))).
