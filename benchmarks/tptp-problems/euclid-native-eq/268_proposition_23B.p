...
fof(propsame_sideition_23,axiom, (! [A,B,C,D,E] : (? [X,Y] : ((( A != B ) & ~ (collinear(D,C,E))) => ((on_ray(A,B,Y) & congruent_angles(X,A,Y,D,C,E))))))).
...
fof(propsame_sideition_23B,conjecture,(! [A,B,C,D,E,P] : (? [X,Y] : ((( A != B ) & ~ (collinear(D,C,E)) & ~ (collinear(A,B,P))) => ((on_ray(A,B,Y) & congruent_angles(X,A,Y,D,C,E) & opposite_sides(X,A,B,P))))))).
