...
fof(p9_9,axiom, ! [X32,NVar30]: ( ( (rf4(c14,NVar30) & p9(X32,NVar30))) => (p9(X32,c13)))).
fof(p9_10,axiom, ! [X32,NVar32]: ( ( (rf4(c14,NVar32) & p9(X32,c13))) => (p9(X32,NVar32)))).
...
fof(p9_21,axiom, ! [X35,X34,X33,NVar58,NVar59,NVar60,NVar61]: ( ( (rf8(X33,X34,NVar61) & rf5(X35,NVar60) & rf4(X34,NVar59) & rf8(X33,X34,NVar58) &  ~(p9(NVar58,NVar59)) & p11(X35,c15) & p9(c12,X33) & p2(X34,NVar60))) => (p9(NVar61,X33)))).
fof(not_p11_22,axiom, ! [X34,X33,X35,NVar63,NVar64,NVar65,NVar66]: ( ( (rf4(X34,NVar66) & rf8(X33,X34,NVar65) & rf8(X33,X34,NVar64) & rf5(X35,NVar63) & p11(X35,c15) & p9(c12,X33) & p2(X34,NVar63) & p9(NVar64,X33) & p9(NVar65,NVar66))) => ($false))).
