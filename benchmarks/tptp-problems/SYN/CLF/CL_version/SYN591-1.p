...
fof(not_p2_10,axiom, (p2(c15,c17)) => ($false)).
fof(p12_11,axiom, ! [NVar11]: ( (rf4(c18,c17,NVar11)) => (p12(c14,NVar11)))).
fof(not_p11_12,axiom, ! [NVar19,NVar20]: ( ( (rf6(c18,NVar20) & rf4(c17,NVar20,NVar19) & p11(c13,NVar19))) => ($false))).
fof(not_p11_13,axiom, ! [NVar27,NVar28]: ( ( (rf6(c18,NVar28) & rf4(NVar28,c17,NVar27) & p11(c13,NVar27))) => ($false))).
...
fof(p2_18,axiom, ! [X22,X21,NVar42,NVar43]: ( ( (rf6(X22,NVar43) & rf6(X21,NVar42) & p2(X21,X22))) => (p2(NVar42,NVar43)))).
...
fof(p11_27,axiom, ! [X9,NVar58,NVar59,NVar60,NVar61,NVar62]: ( ( (rf5(X9,NVar62) & rf4(c17,NVar62,NVar61) & rf4(X9,c17,NVar60) & rf5(X9,NVar59) & rf4(NVar59,c17,NVar58) &  ~(p11(c13,NVar58)) & p12(c14,NVar60))) => (p11(c13,NVar61)))).
