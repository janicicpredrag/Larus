...
fof(p9_10,axiom, ! [X32,NVar32]: ( ( (rf4(c16,NVar32) & p9(X32,NVar32))) => (p9(X32,c13)))).
fof(p9_11,axiom, ! [X32,NVar34]: ( ( (rf4(c16,NVar34) & p9(X32,c13))) => (p9(X32,NVar34)))).
...
fof(p9_22,axiom, ! [X34,X33,NVar60,NVar61,NVar62]: ( ( (rf8(X33,X34,NVar62) & rf4(X34,NVar61) & rf8(X33,X34,NVar60) &  ~(p9(NVar60,NVar61)) & p11(X34,c15) & p9(c12,X33))) => (p9(NVar62,X33)))).
fof(not_p11_23,axiom, ! [X33,X34,NVar64,NVar65,NVar66]: ( ( (rf4(X34,NVar66) & rf8(X33,X34,NVar65) & rf8(X33,X34,NVar64) & p11(X34,c15) & p9(c12,X33) & p9(NVar64,X33) & p9(NVar65,NVar66))) => ($false))).
