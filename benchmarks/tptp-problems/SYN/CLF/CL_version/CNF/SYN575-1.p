...
cnf(i_0_10, plain, (p9(X2,X1)|~p9(X2,c13)|~rf6(c14,X1))).
cnf(i_0_9, plain, (p9(X2,c13)|~p9(X2,X1)|~rf6(c14,X1))).
...
cnf(i_0_21, plain, (p9(X7,X6)|p9(X3,X1)|~p2(X2,X5)|~rf5(X4,X5)|~rf6(X2,X6)|~p11(X4,c15)|~p9(c12,X1)|~rf8(X1,X2,X7)|~rf8(X1,X2,X3))).
cnf(i_0_22, plain, (~p2(X1,X7)|~p9(X5,X3)|~p9(X4,X2)|~rf5(X6,X7)|~rf6(X1,X2)|~p11(X6,c15)|~p9(c12,X3)|~rf8(X3,X1,X5)|~rf8(X3,X1,X4))).
