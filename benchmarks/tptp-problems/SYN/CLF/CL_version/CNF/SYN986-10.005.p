...
cnf(i_0_7, plain, (rtuple(X1,X2,X3,X4,X5,X6,esk1_6(X1,X2,X3,X4,X5,X6)))).
...
cnf(i_0_6, plain, (X7=X8|~rtuple(X1,X2,X3,X4,X5,X6,X8)|~rtuple(X1,X2,X3,X4,X5,X6,X7))).
cnf(i_0_4, plain, (X1!=X14|~rr(zero,X11,X9,X12)|~rr(zero,X9,X7,X10)|~rr(zero,X7,X4,X8)|~rr(zero,X4,X5,X6)|~rr(zero,X2,X11,X13)|~rr(zero,zero,X2,X3)|~rtuple(X13,X12,X10,X8,X6,X3,X14)|~rtuple(true,true,true,true,true,true,X1))).
