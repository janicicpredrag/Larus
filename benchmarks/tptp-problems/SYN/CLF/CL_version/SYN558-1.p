...
fof(p6_3,axiom, ! [X21,NVar3]: ( (rf3(X21,NVar3)) => (p6(c7,NVar3)))).
fof(p5_4,axiom,p5(c7,c10,c9)).
fof(p5_5,axiom,p5(c7,c10,c8)).
fof(p5_6,axiom, ! [X21,NVar12]: ( (rf3(X21,NVar12)) => (p5(c7,X21,NVar12)))).
fof(p2_7,axiom, ! [X7,X6,NVar14,NVar15]: ( ( (rf3(X7,NVar15) & rf3(X6,NVar14) & p2(X6,X7))) => (p2(NVar14,NVar15)))).
