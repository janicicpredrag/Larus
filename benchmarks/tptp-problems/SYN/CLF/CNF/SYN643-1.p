%--------------------------------------------------------------------------
% File     : SYN643-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4298
% Version  : Especial.
% English  :
...
% Rating   : 0.00 v7.1.0, 0.17 v7.0.0, 0.12 v6.3.0, 0.14 v6.2.0, 0.00 v5.0.0, 0.07 v4.1.0, 0.00 v3.5.0, 0.14 v3.4.0, 0.00 v3.1.0, 0.17 v2.7.0, 0.00 v2.6.0, 0.33 v2.5.0
...
cnf(not_p4_28,negated_conjecture,
...
cnf(p4_35,negated_conjecture,
    ( p4(f9(X41,X42),f9(X43,X44))
    | ~ p4(X42,X44)
    | ~ p4(X41,X43) ) ).

cnf(p6_36,negated_conjecture,
    ( p6(f8(f10(X14,X15)),f14(f8(X14),f8(X15)))
    | ~ p15(X14)
    | ~ p15(X15) ) ).

cnf(p4_37,negated_conjecture,
    ( p4(f5(f10(X14,X15)),f9(f5(X14),f5(X15)))
    | ~ p15(X14)
    | ~ p15(X15) ) ).

cnf(p6_38,negated_conjecture,
    ( p6(f7(f10(X14,X15)),f14(f7(X14),f7(X15)))
    | ~ p15(X14)
    | ~ p15(X15) ) ).
