%--------------------------------------------------------------------------
% File     : SYN614-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 3878
% Version  : Especial.
% English  :
...
% Rating   : 0.47 v9.0.0, 0.27 v8.2.0, 0.29 v8.1.0, 0.25 v7.4.0, 0.33 v7.3.0, 0.25 v6.2.0, 0.33 v6.1.0, 0.64 v6.0.0, 0.56 v5.5.0, 0.62 v5.4.0, 0.61 v5.3.0, 0.70 v5.2.0, 0.77 v5.1.0, 0.69 v5.0.0, 0.60 v4.1.0, 0.67 v4.0.1, 0.71 v4.0.0, 0.86 v3.7.0, 0.71 v3.4.0, 0.60 v3.3.0, 0.33 v3.2.0, 0.67 v3.1.0, 0.50 v2.7.0, 0.62 v2.6.0, 0.50 v2.5.0
...
cnf(p19_18,negated_conjecture,
    p19(f6(f3(f4(f5(c22))),f18(c21,f3(f5(c22)))),c24) ).
