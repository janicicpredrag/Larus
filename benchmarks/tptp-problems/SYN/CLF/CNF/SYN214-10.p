%------------------------------------------------------------------------------
% File     : SYN214-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : RPT63 synthetic problem 112 (quasi-uniform distribution)
% Version  : Especial.
% English  :
...
% Rating   : 0.14 v9.0.0, 0.18 v8.2.0, 0.21 v8.1.0, 0.20 v7.5.0
...
% Comments : Converted from SYN214-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
