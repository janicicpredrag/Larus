%--------------------------------------------------------------------------
% File     : SYN603-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 3812
% Version  : Especial.
% English  :
...
% Rating   : 0.20 v9.0.0, 0.18 v8.2.0, 0.14 v8.1.0, 0.00 v7.4.0, 0.17 v7.3.0, 0.00 v6.1.0, 0.36 v6.0.0, 0.33 v5.5.0, 0.31 v5.4.0, 0.33 v5.3.0, 0.45 v5.2.0, 0.38 v5.0.0, 0.33 v4.1.0, 0.40 v4.0.1, 0.43 v3.4.0, 0.20 v3.3.0, 0.00 v2.7.0, 0.25 v2.6.0, 0.33 v2.5.0
...
cnf(p2_19,negated_conjecture,
    p2(f7(f8(c21,c22),c20),f6(f5(f4(c16)),f3(f4(c16)))) ).
...
cnf(not_p15_26,negated_conjecture,
    ( ~ p15(X53,c21)
    | ~ p2(X53,f9(c20,X54))
    | ~ p2(f7(f8(c21,X53),c20),f6(f5(f4(c16)),c17)) ) ).

cnf(p2_27,negated_conjecture,
    ( p2(X21,c22)
    | ~ p15(X21,c21)
    | ~ p2(X21,f9(c20,X22))
    | ~ p2(f7(f8(c21,X21),c20),f6(f5(f4(c16)),X23)) ) ).
