%--------------------------------------------------------------------------
% File     : SYN609-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 3829
% Version  : Especial.
% English  :
...
% Rating   : 0.18 v9.0.0, 0.00 v7.5.0, 0.33 v7.4.0, 0.17 v7.0.0, 0.12 v6.3.0, 0.00 v6.2.0, 0.11 v6.1.0, 0.14 v5.5.0, 0.38 v5.4.0, 0.40 v5.2.0, 0.30 v5.1.0, 0.27 v5.0.0, 0.43 v4.1.0, 0.25 v4.0.1, 0.20 v4.0.0, 0.14 v3.4.0, 0.25 v3.3.0, 0.33 v3.1.0, 0.50 v2.7.0, 0.12 v2.6.0, 0.33 v2.5.0
...
cnf(p17_29,negated_conjecture,
    p17(f9(f10(f14(f4(f9(c19)),c19),f15(f4(f6(f7(f8(c20))))))),f6(f7(f8(c20)))) ).
