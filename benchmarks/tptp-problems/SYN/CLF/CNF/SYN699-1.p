%--------------------------------------------------------------------------
% File     : SYN699-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4651
% Version  : Especial.
% English  :
...
% Rating   : 0.18 v9.0.0, 0.08 v8.2.0, 0.14 v8.1.0, 0.00 v7.1.0, 0.17 v7.0.0, 0.25 v6.3.0, 0.00 v6.2.0, 0.11 v6.1.0, 0.14 v5.5.0, 0.25 v5.4.0, 0.20 v5.2.0, 0.10 v5.1.0, 0.09 v5.0.0, 0.29 v4.1.0, 0.12 v4.0.1, 0.20 v4.0.0, 0.14 v3.4.0, 0.25 v3.3.0, 0.33 v3.1.0, 0.17 v2.7.0, 0.00 v2.6.0, 0.33 v2.5.0
% Syntax   : Number of clauses     :   74 (  31 unt;   2 nHn;  64 RR)
%            Number of literals    :  156 (   0 equ;  83 neg)
...
cnf(not_p2_57,negated_conjecture,
    ~ p2(f11(f4(f23(c47,f9(f20(c37)))),c48),f11(f4(c47),c48)) ).
