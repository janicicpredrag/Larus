%--------------------------------------------------------------------------
% File     : SYN629-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4093
% Version  : Especial.
% English  :
...
% Rating   : 0.27 v8.2.0, 0.14 v8.1.0, 0.00 v7.4.0, 0.17 v7.3.0, 0.00 v6.1.0, 0.29 v6.0.0, 0.44 v5.5.0, 0.38 v5.4.0, 0.39 v5.3.0, 0.50 v5.2.0, 0.38 v5.0.0, 0.33 v4.1.0, 0.40 v4.0.1, 0.57 v4.0.0, 0.43 v3.7.0, 0.29 v3.4.0, 0.20 v3.3.0, 0.00 v2.7.0, 0.38 v2.6.0, 0.33 v2.5.0
...
cnf(not_p20_35,negated_conjecture,
    ~ p20(f16(f17(c26,c27)),f10(f15(f7(c23,f8(c24,c25)),c26),f11(f12(f13(f14(c29)))))) ).

cnf(p20_36,negated_conjecture,
    p20(f15(f7(c23,f8(c24,c25)),c28),f18(f11(f12(f13(f14(c29)))),f15(f7(c23,f8(c24,c25)),c26))) ).
