%------------------------------------------------------------------------------
% File     : SYN193-10 : TPTP v9.0.0. Released v7.3.0.
% Domain   : Puzzles
% Problem  : RPT63 synthetic problem 91 (quasi-uniform distribution)
% Version  : Especial.
% English  :
...
% Rating   : 0.14 v9.0.0, 0.18 v8.2.0, 0.21 v8.1.0, 0.20 v7.5.0, 0.21 v7.4.0, 0.22 v7.3.0
...
% Comments : Converted from SYN193-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
