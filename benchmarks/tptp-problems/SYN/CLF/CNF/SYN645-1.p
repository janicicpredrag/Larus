%--------------------------------------------------------------------------
% File     : SYN645-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4319
% Version  : Especial.
% English  :
...
% Rating   : 0.27 v9.0.0, 0.08 v8.2.0, 0.14 v8.1.0, 0.00 v7.5.0, 0.17 v7.1.0, 0.33 v7.0.0, 0.38 v6.3.0, 0.14 v6.2.0, 0.22 v6.1.0, 0.29 v5.5.0, 0.38 v5.4.0, 0.40 v5.2.0, 0.30 v5.1.0, 0.36 v5.0.0, 0.29 v4.1.0, 0.25 v4.0.1, 0.20 v4.0.0, 0.29 v3.4.0, 0.75 v3.3.0, 0.67 v3.2.0, 0.33 v2.7.0, 0.12 v2.6.0, 0.33 v2.5.0
...
cnf(not_p12_22,negated_conjecture,
...
cnf(f17_is_not_p24_32,negated_conjecture,
    ~ p24(f17(f10(c29,f11(c27,c30)),f16(f10(c29,f11(c27,c30)),c32,c31))) ).
