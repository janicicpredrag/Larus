%------------------------------------------------------------------------------
% File     : SYN116-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : RPT63 synthetic problem 14 (quasi-uniform distribution)
% Version  : Especial.
% English  :
...
% Rating   : 0.14 v8.2.0, 0.17 v8.1.0, 0.20 v7.5.0
...
% Comments : Converted from SYN116-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
