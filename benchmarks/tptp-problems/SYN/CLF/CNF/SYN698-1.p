%--------------------------------------------------------------------------
% File     : SYN698-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4650
% Version  : Especial.
% English  :
...
% Rating   : 0.27 v9.0.0, 0.08 v8.2.0, 0.14 v8.1.0, 0.00 v7.4.0, 0.17 v7.0.0, 0.00 v6.2.0, 0.11 v6.1.0, 0.14 v5.5.0, 0.25 v5.4.0, 0.30 v5.2.0, 0.10 v5.1.0, 0.18 v5.0.0, 0.36 v4.1.0, 0.25 v4.0.1, 0.20 v4.0.0, 0.29 v3.4.0, 0.25 v3.3.0, 0.33 v2.7.0, 0.00 v2.6.0, 0.33 v2.5.0
% Syntax   : Number of clauses     :   74 (  31 unt;   2 nHn;  64 RR)
%            Number of literals    :  156 (   0 equ;  82 neg)
...
cnf(p31_21,negated_conjecture,
    p31(c44,f5(c42)) ).

cnf(p7_22,negated_conjecture,
    p7(f8(c35),c36) ).

cnf(p32_23,negated_conjecture,
    p32(f22(c34,c45),c43) ).

cnf(p31_24,negated_conjecture,
    p31(f23(c44,f9(f20(c37))),c46) ).

cnf(p26_25,negated_conjecture,
    p26(c34,f4(f5(X79)),f4(X79)) ).

cnf(p25_26,negated_conjecture,
    ( p25(X71)
    | ~ p25(X72)
    | ~ p21(X72,X71) ) ).

cnf(p30_27,negated_conjecture,
    ( p30(X93)
    | ~ p30(X94)
    | ~ p17(X94,X93) ) ).

cnf(p29_28,negated_conjecture,
    ( p29(X86)
    | ~ p29(X87)
    | ~ p7(X87,X86) ) ).
...
cnf(p10_38,negated_conjecture,
    ( p10(X6,X7)
    | ~ p10(X5,X6)
    | ~ p10(X5,X7) ) ).

cnf(p7_39,negated_conjecture,
    ( p7(X113,X114)
    | ~ p7(X112,X113)
    | ~ p7(X112,X114) ) ).
...
cnf(p12_46,negated_conjecture,
    ( p12(X13,X14)
    | ~ p12(X12,X13)
    | ~ p12(X12,X14) ) ).

cnf(p33_47,negated_conjecture,
    p33(f11(f4(f5(c42)),c45),f11(f4(c42),c45)) ).
...
cnf(p27_51,negated_conjecture,
    ( p27(X80,X81)
    | ~ p14(X83,X80)
    | ~ p27(X83,X82)
    | ~ p12(X82,X81) ) ).

cnf(p31_52,negated_conjecture,
    ( p31(X96,X97)
    | ~ p2(X99,X97)
    | ~ p31(X98,X99)
    | ~ p2(X98,X96) ) ).
...
cnf(p2_54,negated_conjecture,
    p2(f11(f4(c47),c48),f19(f11(f4(c42),c48),f9(f20(c37)))) ).

cnf(p31_55,negated_conjecture,
    p31(f11(f4(c42),c45),f11(f4(f23(c42,f9(f20(c37)))),c45)) ).
...
cnf(p10_69,negated_conjecture,
    ( p10(X1,X2)
    | p32(f22(c34,X1),X2)
    | ~ p27(f15(c36,f13(X1,X3)),f13(X2,X4)) ) ).

cnf(not_p31_70,negated_conjecture,
    ( ~ p31(X95,c44)
    | ~ p31(X95,f5(c42))
    | ~ p2(f11(f4(f24(X95)),c43),f11(f4(X95),c43)) ) ).

cnf(p26_71,negated_conjecture,
    ( p26(X73,X74,X75)
    | ~ p3(X78,X75)
    | ~ p3(X77,X74)
    | ~ p21(X76,X73)
