%--------------------------------------------------------------------------
% File     : SYN702-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4672
% Version  : Especial.
% English  :
...
% Rating   : 0.00 v8.1.0, 0.25 v7.4.0, 0.17 v7.3.0, 0.25 v6.2.0, 0.17 v6.1.0, 0.00 v5.3.0, 0.10 v5.2.0, 0.00 v2.5.0
% Syntax   : Number of clauses     :   79 (  28 unt;   0 nHn;  52 RR)
%            Number of literals    :  177 (   0 equ;  99 neg)
%            Maximal clause size   :    4 (   2 avg)
%            Maximal term depth    :    8 (   1 avg)
%            Number of predicates  :   26 (  26 usr;   0 prp; 2-2 aty)
%            Number of functors    :   30 (  30 usr;  10 con; 0-2 aty)
...
cnf(not_p47_51,negated_conjecture,
    ~ p47(f20(f22(f24(f26(c55,X65),X66),X67),X68),X68) ).

cnf(p47_52,negated_conjecture,
    ( p47(X151,X152)
    | ~ p47(X153,X154)
    | ~ p7(X154,X152)
    | ~ p4(X153,X151) ) ).

cnf(p11_53,negated_conjecture,
    ( p11(f16(X3,X4),f16(X5,X6))
    | ~ p14(X3,X5)
    | ~ p15(X4,X6) ) ).

cnf(p6_54,negated_conjecture,
    ( p6(f10(X158,X159),f10(X160,X161))
    | ~ p3(X159,X161)
    | ~ p9(X158,X160) ) ).

cnf(p43_55,negated_conjecture,
    ( p43(f46(X140,X141),f46(X142,X143))
    | ~ p4(X141,X143)
    | ~ p45(X140,X142) ) ).

cnf(p41_56,negated_conjecture,
...
cnf(p39_59,negated_conjecture,
    ( p39(f42(X115,X116),f42(X117,X118))
    | ~ p12(X116,X118)
    | ~ p41(X115,X117) ) ).

cnf(p37_60,negated_conjecture,
    ( p37(f38(X108,X109),f38(X110,X111))
    | ~ p12(X108,X110)
    | ~ p7(X109,X111) ) ).

cnf(p33_61,negated_conjecture,
    ( p33(f36(X98,X99),f36(X100,X101))
    | ~ p35(X98,X100)
    | ~ p4(X99,X101) ) ).

cnf(p31_62,negated_conjecture,
...
cnf(p29_65,negated_conjecture,
    ( p29(f32(X73,X74),f32(X75,X76))
    | ~ p12(X74,X76)
    | ~ p31(X73,X75) ) ).

cnf(p27_66,negated_conjecture,
    ( p27(f28(X61,X62),f28(X63,X64))
    | ~ p15(X61,X63)
    | ~ p7(X62,X64) ) ).

cnf(p23_67,negated_conjecture,
    ( p23(f26(X51,X52),f26(X53,X54))
    | ~ p25(X51,X53)
    | ~ p4(X52,X54) ) ).

cnf(p21_68,negated_conjecture,
    ( p21(f24(X44,X45),f24(X46,X47))
    | ~ p15(X45,X47)
    | ~ p23(X44,X46) ) ).

cnf(p19_69,negated_conjecture,
    ( p19(f22(X34,X35),f22(X36,X37))
    | ~ p12(X35,X37)
    | ~ p21(X34,X36) ) ).

cnf(p15_70,negated_conjecture,
    ( p15(f30(X24,X25),f30(X26,X27))
    | ~ p29(X24,X26)
    | ~ p7(X25,X27) ) ).

cnf(p14_71,negated_conjecture,
    ( p14(f18(X17,X18),f18(X19,X20))
    | ~ p17(X17,X19)
    | ~ p4(X18,X20) ) ).

cnf(p12_72,negated_conjecture,
    ( p12(f40(X10,X11),f40(X12,X13))
    | ~ p39(X10,X12)
    | ~ p7(X11,X13) ) ).

cnf(p47_73,negated_conjecture,
    ( p47(X147,X148)
    | ~ p47(f5(c48,f13(f16(f18(c50,X147),X149),X150)),X148) ) ).

cnf(p47_74,negated_conjecture,
    ( p47(X65,X69)
    | ~ p47(f20(f22(f24(f26(c55,X65),X66),X67),X68),X69) ) ).
...
cnf(p47_76,negated_conjecture,
    p47(f5(c48,f8(f10(c49,f13(f16(f18(c50,c51),c52),c53)),c54)),c54) ).

cnf(p27_77,negated_conjecture,
    ( p27(f28(f30(f32(f34(f36(c56,X65),X66),X67),X68),X69),f28(X66,X69))
    | ~ p47(f20(f22(f24(f26(c55,X65),X66),X67),X68),X69) ) ).

cnf(p37_78,negated_conjecture,
    ( p37(f38(f40(f42(f44(f46(c57,X65),X66),X67),X68),X69),f38(X67,X69))
    | ~ p47(f20(f22(f24(f26(c55,X65),X66),X67),X68),X69) ) ).

cnf(p3_79,negated_conjecture,
    p3(f8(f10(c49,f13(f16(f18(c50,X65),X66),X67)),X68),f13(f16(f18(c50,f20(f22(f24(f26(c55,X65),X66),X67),X68)),f30(f32(f34(f36(c56,X65),X66),X67),X68)),f40(f42(f44(f46(c57,X65),X66),X67),X68))) ).
