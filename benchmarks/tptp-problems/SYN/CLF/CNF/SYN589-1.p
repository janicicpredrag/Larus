%--------------------------------------------------------------------------
% File     : SYN589-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 3578
% Version  : Especial.
% English  :
...
% Rating   : 0.07 v9.0.0, 0.00 v8.1.0, 0.25 v7.4.0, 0.33 v7.3.0, 0.25 v6.2.0, 0.17 v6.1.0, 0.07 v6.0.0, 0.11 v5.5.0, 0.06 v5.4.0, 0.11 v5.3.0, 0.20 v5.2.0, 0.08 v5.1.0, 0.06 v5.0.0, 0.07 v4.0.1, 0.14 v3.7.0, 0.00 v2.5.0
...
cnf(p15_16,negated_conjecture,
    p15(f6(f3(f4(f5(c17))),f13(c16,f3(f5(c17)))),c24) ).
