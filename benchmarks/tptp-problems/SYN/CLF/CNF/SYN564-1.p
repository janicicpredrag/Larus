%--------------------------------------------------------------------------
% File     : SYN564-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 2888
% Version  : Especial.
% English  :
...
% Rating   : 0.07 v9.0.0, 0.00 v7.4.0, 0.17 v7.3.0, 0.00 v5.4.0, 0.11 v5.3.0, 0.25 v5.2.0, 0.00 v2.5.0
...
cnf(not_p10_11,negated_conjecture,
    ~ p10(f9(f5(c11),f5(c12)),f5(f8(c11,c12))) ).
