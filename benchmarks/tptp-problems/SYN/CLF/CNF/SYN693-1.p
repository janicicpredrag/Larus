%--------------------------------------------------------------------------
% File     : SYN693-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4627
% Version  : Especial.
% English  :
...
% Rating   : 0.09 v9.0.0, 0.00 v6.2.0, 0.11 v6.1.0, 0.14 v5.5.0, 0.25 v5.4.0, 0.20 v5.2.0, 0.10 v5.1.0, 0.09 v5.0.0, 0.29 v4.1.0, 0.12 v4.0.1, 0.20 v4.0.0, 0.14 v3.4.0, 0.25 v3.3.0, 0.33 v3.1.0, 0.17 v2.7.0, 0.00 v2.6.0, 0.33 v2.5.0
% Syntax   : Number of clauses     :   69 (  27 unt;   2 nHn;  59 RR)
%            Number of literals    :  149 (   0 equ;  80 neg)
...
cnf(p30_24,negated_conjecture,
    ( p30(X92)
    | ~ p30(X93)
    | ~ p17(X93,X92) ) ).

cnf(p29_25,negated_conjecture,
    ( p29(X85)
    | ~ p29(X86)
    | ~ p7(X86,X85) ) ).
...
cnf(p2_51,negated_conjecture,
    p2(f11(f4(c42),c45),f11(f4(f23(c42,f9(f20(c37)))),c45)) ).

cnf(p2_52,negated_conjecture,
    p2(f11(f4(f23(c44,f9(f20(c37)))),c43),f11(f4(c44),c43)) ).

cnf(not_p2_53,negated_conjecture,
...
cnf(p2_58,negated_conjecture,
    ( p2(f11(X46,X47),f11(X48,X49))
    | ~ p10(X47,X49)
    | ~ p3(X46,X48) ) ).

cnf(p17_59,negated_conjecture,
    ( p17(f22(X33,X34),f22(X35,X36))
    | ~ p10(X34,X36)
    | ~ p21(X33,X35) ) ).

cnf(p14_60,negated_conjecture,
