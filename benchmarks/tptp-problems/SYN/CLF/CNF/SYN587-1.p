%--------------------------------------------------------------------------
% File     : SYN587-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 3572
% Version  : Especial.
% English  :
...
% Rating   : 0.00 v6.0.0, 0.14 v5.5.0, 0.12 v5.4.0, 0.10 v5.3.0, 0.00 v5.0.0, 0.07 v4.1.0, 0.00 v2.5.0
% Syntax   : Number of clauses     :   26 (   9 unt;   2 nHn;  21 RR)
%            Number of literals    :   56 (   0 equ;  29 neg)
