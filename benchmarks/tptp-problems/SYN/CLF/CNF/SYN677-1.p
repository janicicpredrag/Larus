%--------------------------------------------------------------------------
% File     : SYN677-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4556
% Version  : Especial.
% English  :
...
% Rating   : 0.09 v9.0.0, 0.08 v8.2.0, 0.14 v8.1.0, 0.00 v5.0.0, 0.07 v4.1.0, 0.00 v2.5.0
...
cnf(p27_41,negated_conjecture,
    p27(f11(f4(c36),c37),f11(f4(f21(c36,f9(f17(c31)))),c37)) ).

cnf(p27_42,negated_conjecture,
    p27(f11(f4(c33),c35),f11(f4(f21(c33,f9(f17(c31)))),c35)) ).

cnf(not_p2_43,negated_conjecture,
    ~ p2(f11(f4(f21(c32,f9(f17(c31)))),c34),f11(f4(c32),c34)) ).

cnf(p2_44,negated_conjecture,
