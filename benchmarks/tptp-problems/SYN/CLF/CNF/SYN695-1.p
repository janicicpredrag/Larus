%--------------------------------------------------------------------------
% File     : SYN695-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4645
% Version  : Especial.
% English  :
...
% Rating   : 0.18 v9.0.0, 0.08 v8.2.0, 0.14 v8.1.0, 0.00 v7.0.0, 0.12 v6.4.0, 0.00 v6.2.0, 0.11 v6.1.0, 0.14 v5.5.0, 0.25 v5.4.0, 0.20 v5.2.0, 0.10 v5.1.0, 0.09 v5.0.0, 0.21 v4.1.0, 0.12 v4.0.1, 0.20 v4.0.0, 0.14 v3.4.0, 0.25 v3.3.0, 0.33 v3.1.0, 0.17 v2.7.0, 0.00 v2.6.0, 0.33 v2.5.0
% Syntax   : Number of clauses     :   73 (  30 unt;   2 nHn;  63 RR)
%            Number of literals    :  155 (   0 equ;  83 neg)
...
cnf(p31_22,negated_conjecture,
    p31(f23(c44,f9(f20(c37))),c45) ).

cnf(p26_23,negated_conjecture,
...
cnf(p30_25,negated_conjecture,
    ( p30(X93)
    | ~ p30(X94)
    | ~ p17(X94,X93) ) ).

cnf(p29_26,negated_conjecture,
    ( p29(X86)
    | ~ p29(X87)
    | ~ p7(X87,X86) ) ).

cnf(p28_27,negated_conjecture,
    ( p28(X84)
    | ~ p28(X85)
    | ~ p14(X85,X84) ) ).
...
cnf(p17_42,negated_conjecture,
    ( p17(X29,X30)
    | ~ p17(X28,X29)
    | ~ p17(X28,X30) ) ).

cnf(p14_43,negated_conjecture,
    ( p14(X20,X21)
    | ~ p14(X19,X20)
    | ~ p14(X19,X21) ) ).
...
cnf(p27_49,negated_conjecture,
    ( p27(X80,X81)
    | ~ p14(X83,X80)
    | ~ p27(X83,X82)
    | ~ p12(X82,X81) ) ).

cnf(p31_50,negated_conjecture,
    ( p31(X96,X97)
    | ~ p2(X99,X97)
    | ~ p31(X98,X99)
    | ~ p2(X98,X96) ) ).

cnf(p32_51,negated_conjecture,
    ( p32(X100,X101)
    | ~ p17(X103,X100)
    | ~ p32(X103,X102)
    | ~ p10(X102,X101) ) ).
...
cnf(p31_53,negated_conjecture,
    p31(f11(f4(c42),c43),f11(f4(f23(c42,f9(f20(c37)))),c43)) ).
...
cnf(not_p2_56,negated_conjecture,
    ~ p2(f11(f4(f23(c46,f9(f20(c37)))),c47),f11(f4(c46),c47)) ).
