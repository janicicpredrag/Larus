%------------------------------------------------------------------------------
% File     : SYN170-10 : TPTP v9.0.0. Released v7.5.0.
% Domain   : Puzzles
% Problem  : RPT63 synthetic problem 68 (quasi-uniform distribution)
% Version  : Especial.
% English  :
...
% Rating   : 0.09 v8.2.0, 0.12 v8.1.0, 0.15 v7.5.0
...
%            Number of variables   :  618 ( 161 sgn)
% SPC      : CNF_UNS_RFO_PEQ_UEQ

% Comments : Converted from SYN170-1 to UEQ using [CS18].
%------------------------------------------------------------------------------
