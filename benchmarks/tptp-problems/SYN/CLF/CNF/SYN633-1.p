%--------------------------------------------------------------------------
% File     : SYN633-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic
% Problem  : Harrison problem 4216
% Version  : Especial.
% English  :
...
% Rating   : 0.09 v9.0.0, 0.08 v8.2.0, 0.14 v8.1.0, 0.00 v7.4.0, 0.17 v7.1.0, 0.33 v7.0.0, 0.25 v6.3.0, 0.14 v6.2.0, 0.11 v6.1.0, 0.14 v5.5.0, 0.25 v5.4.0, 0.40 v5.2.0, 0.20 v5.1.0, 0.18 v5.0.0, 0.29 v4.1.0, 0.12 v4.0.1, 0.20 v4.0.0, 0.14 v3.4.0, 0.25 v3.3.0, 0.33 v3.1.0, 0.17 v2.7.0, 0.00 v2.6.0, 0.33 v2.5.0
...
cnf(p3_33,negated_conjecture,
    ...
    | p10(f11(X9,c27,X10),f11(X9,c27,X11)) ) ).
...
cnf(p3_36,negated_conjecture,
    ...
    | p10(f11(X12,c30,X13),f11(X12,c30,X14)) ) ).
