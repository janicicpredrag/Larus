...
fof(not_p11_12,axiom, (p11(c13,f4(c17,f6(c18)))) => ($false)).
fof(not_p11_13,axiom, (p11(c13,f4(f6(c18),c17))) => ($false)).
...
fof(p11_27,axiom, ! [X9]: ( ( ( ~(p11(c13,f4(f5(X9),c17))) & p12(c14,f4(X9,c17)))) => (p11(c13,f4(c17,f5(X9)))))).
