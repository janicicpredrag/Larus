...
fof(p9_9,axiom, ! [X32]: ( (p9(X32,f6(c14))) => (p9(X32,c13)))).
fof(p9_10,axiom, ! [X32]: ( (p9(X32,c13)) => (p9(X32,f6(c14))))).
...
fof(p9_21,axiom, ! [X35,X34,X33]: ( ( ( ~(p9(f8(X33,X34),f6(X34))) & p11(X35,c15) & p9(c12,X33) & p2(X34,f5(X35)))) => (p9(f8(X33,X34),X33)))).
fof(not_p11_22,axiom, ! [X34,X33,X35]: ( ( (p11(X35,c15) & p9(c12,X33) & p2(X34,f5(X35)) & p9(f8(X33,X34),X33) & p9(f8(X33,X34),f6(X34)))) => ($false))).
