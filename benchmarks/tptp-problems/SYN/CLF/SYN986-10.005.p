...
fof(ck,axiom, ! [Z0,Z1,Z2,Z3,Z4,Z5]: (tuple(r(zero,Z5,Z4),r(zero,Z4,Z3),r(zero,Z3,Z2),r(zero,Z2,Z1),r(zero,Z1,Z0),r(zero,zero,Z5)) != tuple(true,true,true,true,true,true))).
