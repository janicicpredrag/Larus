...
fof(p9_10,axiom, ! [X32]: ( (p9(X32,f4(c16))) => (p9(X32,c13)))).
fof(p9_11,axiom, ! [X32]: ( (p9(X32,c13)) => (p9(X32,f4(c16))))).
...
fof(p9_22,axiom, ! [X34,X33]: ( ( ( ~(p9(f8(X33,X34),f4(X34))) & p11(X34,c15) & p9(c12,X33))) => (p9(f8(X33,X34),X33)))).
fof(not_p11_23,axiom, ! [X33,X34]: ( ( (p11(X34,c15) & p9(c12,X33) & p9(f8(X33,X34),X33) & p9(f8(X33,X34),f4(X34)))) => ($false))).
