%------------------------------------------------------------------------------
% File     : SYN993^1 : TPTP v9.0.0. Released v3.7.0.
% Domain   : Syntactic
% Problem  : Skolemization test 1
% Version  : Especial.
% English  :
...
% Source   : [Ben09]
% Names    : Example 2a [BB05]

% Status   : CounterSatisfiable
% Rating   : 0.33 v9.0.0, 0.00 v6.2.0, 0.33 v6.0.0, 0.00 v5.5.0, 0.33 v4.1.0, 0.00 v3.7.0
