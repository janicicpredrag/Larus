%--------------------------------------------------------------------------
% File     : SYN877-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF, SSS - K=4 C=40 V=4 D=4.2
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnfSSS-K4-C40-V4-D4.2 [Sch01]
...
% Syntax   : Number of clauses     :   76 (   1 unt;  30 nHn;  28 RR)
%            Number of literals    : 1210 (   0 equ;1100 neg)
...
%            Number of variables   : 1014 (  75 sgn)
