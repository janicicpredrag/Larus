%--------------------------------------------------------------------------
% File     : SYN139-1 : TPTP v9.0.0. Released v1.1.0.
% Domain   : Syntactic (Random Prolog Theory)
% Problem  : RPT63 synthetic problem 37 (quasi-uniform distribution)
...
% Rating   : 0.00 v7.3.0, 0.10 v7.2.0, 0.11 v7.1.0, 0.14 v7.0.0, 0.00 v6.2.0, 0.12 v6.1.0, 0.00 v2.2.0, 0.33 v2.1.0, 0.00 v2.0.0
