%--------------------------------------------------------------------------
% File     : SYN869-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF, SSS - K=4 C=20 V=4 D=4.1
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnfSSS-K4-C20-V4-D4.1 [Sch01]
...
% Syntax   : Number of clauses     :   56 (   1 unt;  15 nHn;  19 RR)
