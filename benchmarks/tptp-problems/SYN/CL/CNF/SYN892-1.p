%--------------------------------------------------------------------------
% File     : SYN892-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF, SSS - K=4 C=50 V=4 D=4.7
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnfSSS-K4-C50-V4-D4.7 [Sch01]
...
% Syntax   : Number of clauses     :   86 (   1 unt;  34 nHn;  30 RR)
%            Number of literals    : 1399 (   0 equ;1276 neg)
...
%            Number of variables   : 1163 (  85 sgn)
