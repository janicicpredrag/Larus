%--------------------------------------------------------------------------
% File     : SYN878-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF, SSS - K=4 C=40 V=4 D=4.5
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnfSSS-K4-C40-V4-D4.5 [Sch01]
...
% Syntax   : Number of clauses     :   76 (   1 unt;  27 nHn;  28 RR)
%            Number of literals    : 1205 (   0 equ;1100 neg)
...
%            Number of variables   : 1009 (  75 sgn)
