%--------------------------------------------------------------------------
% File     : SYN819-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF - K=4 C=30 V=4 D=4.2
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnf-K4-C30-V4-D4.2 [Sch01]

% Status   : Unsatisfiable
% Rating   : 0.14 v9.0.0, 0.00 v7.3.0, 0.20 v7.2.0, 0.22 v7.1.0, 0.29 v7.0.0, 0.14 v6.4.0, 0.17 v6.3.0, 0.25 v6.2.0, 0.12 v6.1.0, 0.25 v6.0.0, 0.00 v5.5.0, 0.20 v5.4.0, 0.33 v5.0.0, 0.17 v4.1.0, 0.40 v3.7.0, 0.25 v3.5.0, 0.00 v3.3.0, 0.33 v3.2.0, 0.00 v3.1.0, 0.33 v2.7.0, 0.00 v2.6.0, 0.38 v2.5.0
% Syntax   : Number of clauses     :  544 (   1 unt;  76 nHn; 303 RR)
%            Number of literals    : 8365 (   0 equ;7701 neg)
%            Maximal clause size   :   24 (  15 avg)
%            Maximal term depth    :    1 (   1 avg)
%            Number of predicates  :  345 ( 345 usr;   1 prp; 0-20 aty)
%            Number of functors    :   16 (  16 usr;  16 con; 0-0 aty)
%            Number of variables   : 7081 ( 423 sgn)
% SPC      : CNF_UNS_EPR_NEQ_NHN

% Comments : Optimised functional translation in terms of n-ary predicates
%            for the modal QBF formula.
%--------------------------------------------------------------------------
...
cnf(clause213,negated_conjecture,
    ...
    | ~ ssNder1_1r1(U)
    | ~ ssNder1_0
    | ssPv4_11r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5)
...
cnf(clause214,negated_conjecture,
    ...
    | ~ ssNder1_0
    | ssPv6_11r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5)
    | ssPv9_11r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5)
    | ssPv10_11r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5) ) ).
...
cnf(clause216,negated_conjecture,
    ...
    | ~ ssNder1_1r1(U)
    | ~ ssNder1_0
    | ssPv3_11r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5)
    | ssPv8_11r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5)
    | ssPv16_11r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5) ) ).
...
cnf(clause247,negated_conjecture,
    ...
    | ~ ssNder1_1r1(U)
    | ~ ssNder1_0
    | ssPv3_12r1r1r1r1r1r1r1r1r1r1r1r1(U,V,W,X,Y,Z,X1,X2,X3,X4,X5,X6)
