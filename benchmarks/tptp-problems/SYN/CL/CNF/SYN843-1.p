%--------------------------------------------------------------------------
% File     : SYN843-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF, Ladn - K=4 C=40 V=4 D=4.2
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnfLadn-K4-C40-V4-D4.2 [Sch01]

% Status   : Unsatisfiable
% Rating   : 0.14 v9.0.0, 0.00 v7.3.0, 0.10 v7.2.0, 0.11 v7.1.0, 0.14 v6.4.0, 0.17 v6.3.0, 0.50 v6.2.0, 0.00 v6.1.0, 0.12 v6.0.0, 0.00 v5.5.0, 0.20 v5.4.0, 0.33 v5.0.0, 0.17 v4.1.0, 0.40 v3.7.0, 0.25 v3.5.0, 0.00 v3.3.0, 0.33 v3.2.0, 0.00 v3.1.0, 0.22 v2.7.0, 0.17 v2.6.0, 0.38 v2.5.0
% Syntax   : Number of clauses     :  576 (   1 unt;  88 nHn; 351 RR)
%            Number of literals    : 8834 (   0 equ;8150 neg)
%            Maximal clause size   :   24 (  15 avg)
%            Maximal term depth    :    1 (   1 avg)
%            Number of predicates  :  365 ( 365 usr;   1 prp; 0-20 aty)
%            Number of functors    :   16 (  16 usr;  16 con; 0-0 aty)
%            Number of variables   : 7398 ( 415 sgn)
