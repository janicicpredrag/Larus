%--------------------------------------------------------------------------
% File     : SYN833-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF, Ladn - K=4 C=30 V=4 D=4.3
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnfLadn-K4-C30-V4-D4.3 [Sch01]
...
% Syntax   : Number of clauses     :  536 (   1 unt;  64 nHn; 315 RR)
%            Number of literals    : 8107 (   0 equ;7499 neg)
%            Maximal clause size   :   24 (  15 avg)
%            Maximal term depth    :    1 (   1 avg)
%            Number of predicates  :  343 ( 343 usr;   1 prp; 0-20 aty)
%            Number of functors    :   16 (  16 usr;  16 con; 0-0 aty)
%            Number of variables   : 6831 ( 415 sgn)
