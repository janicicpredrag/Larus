%--------------------------------------------------------------------------
% File     : SYN835-1 : TPTP v9.0.0. Released v2.5.0.
% Domain   : Syntactic (Translated)
% Problem  : QBF, Ladn - K=4 C=30 V=4 D=4.6
% Version  : Especial.
% English  :
...
% Source   : [Sch01]
% Names    : p-qbf-cnfLadn-K4-C30-V4-D4.6 [Sch01]

% Status   : Satisfiable
% Rating   : 0.00 v7.3.0, 0.25 v7.0.0, 0.20 v6.4.0, 0.33 v6.3.0, 0.25 v6.2.0, 0.17 v6.1.0, 0.20 v6.0.0, 0.33 v5.5.0, 0.00 v4.1.0, 0.12 v4.0.1, 0.00 v3.5.0, 0.25 v3.4.0, 0.00 v3.1.0, 0.17 v2.7.0, 0.00 v2.6.0, 0.33 v2.5.0
% Syntax   : Number of clauses     :  536 (   1 unt;  96 nHn; 303 RR)
%            Number of literals    : 8163 (   0 equ;7475 neg)
%            Maximal clause size   :   24 (  15 avg)
%            Maximal term depth    :    1 (   1 avg)
%            Number of predicates  :  346 ( 346 usr;   1 prp; 0-20 aty)
%            Number of functors    :   16 (  16 usr;  16 con; 0-0 aty)
%            Number of variables   : 6887 ( 415 sgn)
% SPC      : CNF_SAT_EPR_NEQ
