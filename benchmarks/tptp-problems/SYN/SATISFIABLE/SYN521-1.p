%--------------------------------------------------------------------------
% File     : SYN521-1 : TPTP v9.0.0. Released v2.1.0.
...
% Source   : [Wei97]
% Names    : alc-5-1-20-3-2-049.cnf [Wei97]

% Status   : Satisfiable
% Rating   : 0.00 v2.2.1, 0.33 v2.2.0, 0.50 v2.1.0
% Syntax   : Number of clauses     :  102 (   0 unt;  54 nHn;  89 RR)
%            Number of literals    :  334 (   0 equ; 170 neg)
