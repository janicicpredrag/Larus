%--------------------------------------------------------------------------
% File     : SYN431-1 : TPTP v9.0.0. Released v2.1.0.
...
% Source   : [Wei97]
% Names    : alc-4-1-16-3-1-042.cnf [Wei97]

% Status   : Satisfiable
% Rating   : 0.00 v6.2.0, 0.17 v6.1.0, 0.00 v2.4.0, 0.00 v2.2.1, 0.33 v2.2.0, 0.50 v2.1.0
% Syntax   : Number of clauses     :  132 (   0 unt;  16 nHn; 132 RR)
%            Number of literals    :  325 (   0 equ; 200 neg)
