%--------------------------------------------------------------------------
% File     : SYN092-1.003 : TPTP v9.0.0. Bugfixed v1.2.1.
% Domain   : Syntactic
...
% Status   : Satisfiable
% Rating   : 0.00 v2.1.0
% Syntax   : Number of clauses     :   42 (   0 unt;  17 nHn;  42 RR)
%            Number of literals    :  116 (   0 equ;  58 neg)
%            Maximal clause size   :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of predicates  :   28 (  28 usr;  28 prp; 0-0 aty)
