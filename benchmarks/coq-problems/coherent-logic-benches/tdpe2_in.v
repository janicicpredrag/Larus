...
Variable ax18_10 : (forall B C : Universe, (tExists_22_ B C -> (exists D : Universe, (dom_ D /\ tAnd_20_ B C D)))).
Variable ax08_11 : (forall B C D : Universe, (tAnd_20_ B C D -> (tTRANSITIVE_REFLEXIVE_REWRITE_ B D /\ tTRANSITIVE_REFLEXIVE_REWRITE_ C D))).
Variable ax19_12 : (forall B C : Universe, (tExists_26_ B C -> (exists D : Universe, (dom_ D /\ tAnd_24_ B C D)))).
Variable ax05_13 : (forall B C D : Universe, (tAnd_24_ B C D -> (tTRANSITIVE_REFLEXIVE_REWRITE_ B D /\ tTRANSITIVE_REFLEXIVE_REWRITE_ C D))).
Variable ax17_14 : (forall A B : Universe, (tTRANSITIVE_REFLEXIVE_REWRITE_ A B -> (tEQUALISH_ A B \/ tExists_30_ A B))).
Variable ax20_15 : (forall A B : Universe, (tExists_30_ A B -> (exists C : Universe, (dom_ C /\ tAnd_28_ A C B)))).
Variable ax02_16 : (forall A C B : Universe, (tAnd_28_ A C B -> (tREWRITE_ A C /\ tTRANSITIVE_REFLEXIVE_REWRITE_ C B))).

Theorem tdpe2_17 : goal_.
Proof.
  time tac.
Qed.
