...
/*    "fof(cn_equalitysub,axiom, ! [A,B,C,D] : (( eq(D,A) & col(A,B,C))  => col(D,B,C)))",
    "fof(cn_equalitysubbet1,axiom, ! [A,B,C,D] : (( eq(D,A) & betS(A,B,C))  => betS(D,B,C)))",
    "fof(cn_equalitysubbet2,axiom, ! [A,B,C,D] : (( eq(D,B) & betS(A,B,C))  => betS(A,D,C)))",
    "fof(cn_equalitysubbet3,axiom, ! [A,B,C,D] : (( eq(D,C) & betS(A,B,C))  => betS(A,B,D)))",*/
...
//    "fof(defcollinear2,axiom,! [ A,B,C] :  ( (eq(A,B) | eq(A,C) | eq(B,C) | betS(B,A,C) | betS(A,B,C) | betS(A,C,B)))  => col(A,B,C))",
    ...
    "fof(defparallel,axiom,! [ A,B,C,D] : par(A,B,C,D) => ? [ U,V,u,v,X] :  ( neq(A,B) & neq(C,D) & col(A,B,U) & col(A,B,V) & neq(U,V) & col(C,D,u) & col(C,D,v) & neq(u,v) & nmeet(A,B,C,D) & betS(U,X,v) & betS(u,X,V)))",
    "fof(defparallel2,axiom,! [ A,B,C,D, U,V,u,v,X] :  ( neq(A,B) & neq(C,D) & col(A,B,U) & col(A,B,V) & neq(U,V) & col(C,D,u) & col(C,D,v) & neq(u,v) & nmeet(A,B,C,D) & betS(U,X,v) & betS(u,X,V))  => par(A,B,C,D))",
