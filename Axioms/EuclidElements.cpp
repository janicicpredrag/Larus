...
{   
     ...
     "fof(col_trans1, axiom, ! [A,B,C] : neqcol(P,Q,A) & colcol(P,Q,B,C) => col(A,B,C) )",
     ...
     "fof(ex1, conjecture, ! [A,B,C] : neq(A,B) & col(A,B,C) & col(A,B,D) => col(A,C,D) )"
};
...
{   
    ...
    "fof(cn_equalitysub,axiom, ! [A,B,C,D] : (( eq(D,A) & betS(A,B,C) )  => betS(D,B,C)) )",
