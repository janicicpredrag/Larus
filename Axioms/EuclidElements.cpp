...
//    "fof(defcollinear2,axiom,! [ A,B,C] :  ( (eq(A,B) | eq(A,C) | eq(B,C) | betS(B,A,C) | betS(A,B,C) | betS(A,C,B)))  => col(A,B,C))",
    ...
    "fof(defequalangles,axiom,! [ A,B,C,Ca,Cb,Cc] : congA(A,B,C,Ca,Cb,Cc) => ? [ U,V,Su,Sv] :  ( out(B,A,U) & out(B,C,V) & out(Cb,Ca,Su) & out(Cb,Cc,Sv) & cong(B,U,Cb,Su) & cong(B,V,Cb,Sv) & cong(U,V,Su,Sv) & nCol(A,B,C)))",
    ...
    "fof(defparallel,axiom,! [ A,B,C,D] : par(A,B,C,D) => ? [ U,V,Su,Sv,X] :  ( neq(A,B) & neq(C,D) & col(A,B,U) & col(A,B,V) & neq(U,V) & col(C,D,Su) & col(C,D,Sv) & neq(Su,Sv) & nmeet(A,B,C,D) & betS(U,X,Sv) & betS(Su,X,V)))",
  ...
  //  "fof(deftangentline2,axiom,! [ A,B,J,E] : ! [ C,P,Q] :  ( cI(J,C,P,Q) & onCirc(E,J) & betS(A,E,B) & ~(A,B,J))  => (A,B,J,E))",
    ...
    "fof(defequalrectangles,axiom,! [ A,B,C,D,Ca,Cb,Cc,Cd] : eR(A,B,C,D,Ca,Cb,Cc,Cd) => ? [ X,Y,Z,U,Sx,Sz,Su,Sw,W] :  ( rC(A,B,C,D,X,Y,Z,U) & rC(Ca,Cb,Cc,Cd,Sx,Y,Sz,Su) & betS(Sx,Y,Z) & betS(X,Y,Sz) & betS(W,U,Sw)))",
    "fof(defequalrectangles2,axiom,! [ A,B,C,D,Ca,Cb,Cc,Cd, X,Y,Z,U,Sx,Sz,Su,Sw,W] :  ( rC(A,B,C,D,X,Y,Z,U) & rC(Ca,Cb,Cc,Cd,Sx,Y,Sz,Su) & betS(Sx,Y,Z) & betS(X,Y,Sz) & betS(W,U,Sw))  => eR(A,B,C,D,Ca,Cb,Cc,Cd))",
    ...
    "fof(defequaltriangles2,axiom,! [ A,B,C,Ca,Cb,Cc, X,Y,Sx,Sy] :  ( rE(A,B,X,Y) & rE(Ca,Cb,Sx,Sy) & col(X,Y,C) & col(Sx,Sy,Cc) & eR(A,B,X,Y,Ca,Cb,Sx,Sy))  => tE(A,B,C,Ca,Cb,Cc))",
    "fof(defequalfigures,axiom,! [ A,B,C,D,Ca,Cb,Cc,Cd] : fE(A,B,C,D,Ca,Cb,Cc,Cd) => ? [ X,Y,Z,U,Sx,Sy,Sz,Su] :  ( tS(A,B,C,D) & tS(Ca,Cb,Cc,Cd) & fR(A,B,C,D,X,Y,Z,U) & fR(Ca,Cb,Cc,Cd,Sx,Sy,Sz,Su) & eR(X,Y,Z,U,Sx,Sy,Sz,Su)))",
    "fof(defequalfigures2,axiom,! [ A,B,C,D,Ca,Cb,Cc,Cd, X,Y,Z,U,Sx,Sy,Sz,Su] :  ( tS(A,B,C,D) & tS(Ca,Cb,Cc,Cd) & fR(A,B,C,D,X,Y,Z,U) & fR(Ca,Cb,Cc,Cd,Sx,Sy,Sz,Su) & eR(X,Y,Z,U,Sx,Sy,Sz,Su))  => fE(A,B,C,D,Ca,Cb,Cc,Cd))",
    "fof(defequaltrianglefigure,axiom,! [ A,B,C,Ca,Cb,Cc,Cd] : tF(A,B,C,Ca,Cb,Cc,Cd) => ? [ X,Y,Sx,Sy,Sz,Su] :  ( bR(A,B,C,X,Y) & fR(Ca,Cb,Cc,Cd,Sx,Sy,Sz,Su) & eR(B,C,X,Y,Sx,Sy,Sz,Su)))",
    "fof(defequaltrianglefigure2,axiom,! [ A,B,C,Ca,Cb,Cc,Cd, X,Y,Sx,Sy,Sz,Su] :  ( bR(A,B,C,X,Y) & fR(Ca,Cb,Cc,Cd,Sx,Sy,Sz,Su) & eR(B,C,X,Y,Sx,Sy,Sz,Su))  => tF(A,B,C,Ca,Cb,Cc,Cd))",
