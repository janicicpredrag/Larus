...
const string DEFAULT_HAMMER = "vampire --mode casc --cores 0 --proof tptp --output_axiom_names on # "; //
const string DEFAULT_HAMMER_FOR_ABDUCTS = "vampire --mode casc --cores 0 --proof tptp --output_axiom_names on # "; //
